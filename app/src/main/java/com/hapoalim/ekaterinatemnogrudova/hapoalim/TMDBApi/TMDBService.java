...
import static com.hapoalim.ekaterinatemnogrudova.hapoalim.utils.Constants.BASE_URL;
...
public class TMDBService {
    ...
    public Observable<FilmsResponse> getFilms(String apiKey, String page) {
        return  TMDBApi.getFilms(apiKey, page);
    }
}
